...
public class Task6 {
    ...
    public static int[][] createMatrixOnTheModel(int rows, int columns) {
        ...
        for (int i = 0; i < array.length/2 ; i++){ // этим циклом заполняется верхняя половина матрицы единицами
            ...
            jCounte += 1; /* увеличиваем переменную на каждой новой строке. Тем самым начинаем заполнять
            единицами со смещением счетчика строки на величину переменной и заполняем до величины длинны
            массива за вычетом пременной
            */
        }
